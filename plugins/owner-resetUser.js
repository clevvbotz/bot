 ...
 // if(number.length > 8) return conn.reply(m.chat, `*❏ USUARIO REINICIADO*\n\n¡El número que ingresó no es válido!`, m)
  ...
  let participants = m.isGroup ? groupMetadata.participants : []
	...
	delete global.global.db.data.users[user]
 	...
 	conn.reply(m.chat, `*❏ RESET USER DATABASE*\n\nBerhasil reset database ke @${number} dari *DATABASE*`, null, { mentions: [user] })
